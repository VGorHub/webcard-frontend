...
import { ExternalLink, Github, Eye, Loader2, FolderOpen } from "lucide-react"
        ...
        setProjects([
          {
            ...
            description:
              "Высоконагруженное приложение для распределения задач среди сотрудников с real-time уведомлениями",
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  {activeCategory === "Все"
                    ...
                    : `Нет проектов в категории "${activeCategory}"`}
                </p>
              </div>
            )}
          </>
